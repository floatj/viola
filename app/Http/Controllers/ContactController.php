...
class ContactController extends Controller
{
    ...
    /**
     * 寄出聯絡詢問信 (1->客戶公司信箱   2->詢問者)
     *
     * @param $input_data
     *
     */
    public function inquiryProductSendMails($insert_data, $supplier, $sup_no)
    {
	...
	if($ret == "202 Accepted")
	{
        ...
        $message2 .= "<br><br>本公司已收到您詢問主旨 [".$insert_data['subject']."] 聯絡信";
        ...
        //詢問者mail
        $subject= "=?UTF-8?B?".base64_encode('系統自動通告-已收到您的聯絡信!')."?=";
