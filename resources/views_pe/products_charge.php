  ...
  <div class="page-header">
    ...
    <div id="products" class="row">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
             ...
             <div id="pro_pic"><img src="img/pp.jpg" class="img-responsive"></div>
           
           </div>
         
          <div class="col-md-6 col-sm-6 col-xs-12">
           
             <div id="pro_h1"><h2>產 品 名 稱</h2></div>
             
             <div id="pro_h2">產 品 編 號 :</div>
             
             <div id="pro_h2">產 品 價 格 : 來電洽詢</div>
             
             <div id="pro_h2">交 貨 天 數 : 0 天</div>
             
             <div id="pro_h2">最 少 訂 購 量 : 來電洽詢</div>
    ...
    <div id="contact" class="row">
      ...
      <div id="con_list" class="col-md-12 col-xs-12">編　　號：<br><input class="con_input" type="text" name="input"></div>
      <div id="con_list" class="col-md-12 col-xs-12">產品名稱：<br><input class="con_input" type="text" name="input"></div>
      <div id="con_list" class="col-md-12 col-xs-12">* 主　　旨：<br><input class="con_input" type="text" name="input"></div>
      <div id="con_list" class="col-md-12 col-xs-12">您的需求：<br><textarea class="medium" name="textarea" rows="5" style="width:99%;"></textarea></div>
